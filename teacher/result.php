<style type="text/css">
	...
	::-webkit-input-placeholder { color:#666; font-size:12px; font-weight:bold}
	::-moz-placeholder { color:#666;  font-size:12px;  font-weight:bold} /* firefox 19+ */
	:-ms-input-placeholder { color:#666;  font-size:12px;  font-weight:bold} /* ie */
	input:-moz-placeholder { color:#666;  font-size:12px;  font-weight:bold}	
</style>
...
<table width="100%" class="table table-bordered" border="1" id="resultEntry" align="left">
  <tr bgcolor="#B7B7B7" style="color:white">
    <th>Student Id</th>
    <th>Mid Subjective<br /> Marks</th>
    <th>Mid Objective<br /> Marks</th>
    <th>1st Tutorial</th>
    <th>2nd Tutorial</th>

    <th>Final Subjecttive<br /> Marks</th>
    <th>Final Objective<br /> Marks</th>
    <th>3rd Tutorial</th>
    <th>4th Tutorial</th>
  </tr>
        ...
        for($i=0; $i<count($r); $i++){
			...
			$re = new Result();
			 ...
			 if(($resultRow != "") && count($resultRow)>0){
				...
				echo "<td class='studentId'>".'<input class="number" readonly="readonly" value="'.$r[$i][0].'" class="number" type="text" name="sm" size="6" />'."</td>";
				
				echo "<td>".'<input class="number" type="text" value="'.$mSubjective.'" name="om" size="9" placeholder="Mid Subjective" />'."</td>";
				echo "<td>".'<input class="number" type="text" value="'.$mObjective.'" name="om" size="9"placeholder="Mid Objective" />'."</td>";
				echo "<td>".'<input class="number" type="text" value="'.$firstTutorial.'" name="om" size="9" placeholder="1st Tutorial" />'."</td>";
				echo "<td>".'<input class="number" type="text" value="'.$secondTutorial.'" name="om" size="9" placeholder="Final Subjective" />'."</td>";
		   		echo "<td>".'<input class="number" type="text" value="'.$fSubjective.'" name="om" size="9" placeholder="Final Objective" />'."</td>";
		   
				echo "<td>".'<input class="number" type="text" value="'.$fObjective.'" name="two" size="9"  placeholder="2nd Tutorial"/>'."</td>";
				echo "<td>".'<input class="number" type="text" value="'.$thirdTutorial.'" name="three" size="9" placeholder="3rd Tutorial" />'."</td>";
				
			
				echo "<td>".'<input class="number" type="text" name="four" size="9" value="'.$fourthTutorial.'"  placeholder="4th Tutorial"/>
				<input class="number" type="hidden" name="checkIsNew" value="2" size="9" />'."</td>";
				echo "</tr>";
			 }else{//if is not new 
				echo "<tr class='trContainer'>";
				echo "<td class='studentId'>".'<input class="number" readonly="readonly" value="'.$r[$i][0].'" class="number" type="text" name="sm" size="6" />'."</td>";
				
				echo "<td>".'<input class="number" type="text" name="om" size="9" placeholder="Mid Subjective" />'."</td>";
				echo "<td>".'<input class="number" type="text" name="om" size="9"placeholder="Mid Objective" />'."</td>";
				echo "<td>".'<input class="number" type="text" name="om" size="9" placeholder="1st Tutorial" />'."</td>";
				echo "<td>".'<input class="number" type="text" name="om" size="9" placeholder="2nd Tutorial" />'."</td>";
		   		echo "<td>".'<input class="number" type="text" name="om" size="9" placeholder="Final Subjective" />'."</td>";
		   		echo "<td>".'<input class="number" type="text" name="two" size="9"  placeholder="Final Objective"/>'."</td>";
				echo "<td>".'<input class="number" type="text" name="three" size="9" placeholder="3rd Tutorial" />'."</td>";
				echo "<td>".'<input class="number" type="text" name="four" size="9"  placeholder="4th Tutorial"/>
				<input class="number" type="hidden" name="checkIsNew" value="1" size="9" />'."</td>";
				echo "</tr>";
			 }//end of else
...
<div class="row marg" style="margin-left: 70px">
...
<!--<div class="row">
	<div class="col-lg-12">
    	<h2>Hello World How are your?? Where are you?? Where are you going??</h2>
    </div>
    <div class="col-lg-6">
    	<h2>Hello World How are your?? Where are you?? Where are you going??</h2>
    </div>
