...
<table width="100%" border="1" align="left"><!--table academic result-->    
        <tr>
            ...
            <?php ?>
            <th colspan="9"><center><b>Final Exam</b></center></th>
           <th colspan="4"><center><b>Aggregate</b></center></th>
        
        </tr>

		<tr id="table-result-show-header">       
            <td width="25%">Subject</td>
            <td width="3%">Full Marks</td>
            <td width="2%"><center>Sub M</center></td>
            <td width="2%"><center>Obj M</center></td>
            <td width="2%"><center>1st T</center></td>            
            <td width="2%"><center>2nd T</center></td>
            <td width="3%"><center>Total</center></td>
            <td width="2%"><center>LG</center></td>
            <td width="2%"><center>GP</center></td>
            <td width="3%"><center>H M Section<center></td>
            <td width="3%"><center>H M Class</center></td>
  
            <td width="2%"><center>Sub M</center></td>
            <td width="2%"><center>Obj M</center></td>
            <td width="2%"><center>3rd T</center></td>            
            <td width="2%"><center>4th T</center></td>
            <td width="3%"><center>Total</center></td>
            <td width="2%"><center>LG</center></td>
            <td width="2%"><center>GP</center></td>
            <td width="3%"><center>H M Section</center></td>
            ...
            <td width="3%"><center>Total</center></td>
            <td width="3%"><center>Avg</center></td>
            <td width="2%"><center>LG</center></td>
            <td width="3%"><center>GP</center></td>
		...
		$aggregateAvgTotal=0;
			...
			$result->Select();
                ...
                for($i=0; $i<count($r); $i++){ /*start loop for search result*/
					...
					echo "<td>".$r[$i][8]."</td>";
					echo "<td>".$r[$i][9]."</td>";
				    echo "<td>".$totalFinal=$r[$i][13]."</td>";
                    
					echo "<td>";
					if(($r[$i][13])>=80){
						echo "A+";
						}else if(($r[$i][13])<=79 && ($r[$i][13]>=70)){
							echo "A";
						}else if(($r[$i][13])<=69 && ($r[$i][13]>=60)){
							echo "A-";
						}
						else if(($r[$i][13])<=59 && ($r[$i][13]>=50)){
						echo "B";
						}
						else if(($r[$i][13])<=49 && ($r[$i][13]>=40)){
						echo "C";	
						}
						else if(($r[$i][13])<=39 && ($r[$i][13]>=33)){
						echo "D";	
						}
						else{
						echo "F";	
					...
					$sectionFinalHighest = $result->SelectMaxMarks($r[$i][10], $r[$i][11], $r[$i][14]);
					$classFinalHighest = $result->SelectMaxMarks($r[$i][10], "", $r[$i][14]);
					
					
					echo "<td>".$sectionFinalHighest[0][1]."</td>";
					echo "<td>".$sectionFinalHighest[0][1]."</td>";
					
					
					echo "<td>";
					$total=$totalMid+$totalFinal;
					echo $total;
					echo"</td>";
		...
		echo "<td>";echo $totalFinalSum;echo "</td>";
		echo "<td>";  
		$totalFinalSumCount=$totalFinalSum/$count;  
		
		
                	if($totalFinalSumCount>=80){
						echo "A+";
						}else if($totalFinalSumCount<=79 && $totalFinalSumCount>=70){
							echo "A";
						}else if($totalFinalSumCount<=69 && $totalFinalSumCount>=60){
							echo "A-";
						}
						else if($totalFinalSumCount<=59 && $totalFinalSumCount>=50){
						echo "B";
						}
						else if($totalFinalSumCount<=49 && $totalFinalSumCount>=40){
						echo "C";	
						}
						else if($totalFinalSumCount<=39 && $totalFinalSumCount>=33){
						echo "D";	
						}
						else{
						echo "F";	
		...
		echo "<td>";
		echo $totalMidSum+$totalFinalSum;
		$aggregateAvgTotal=round(((($totalMidSum+$totalFinalSum)/2)/$count),0);
		echo "</td>";
		
		echo "<td>";
		$aggregateAvg=round((($totalMidSum+$totalFinalSum)/2),2);
		echo $aggregateAvg;
		echo "</td>";
		
		echo "<td>";  
				//echo $aggregateAvgTotal;
                	if($aggregateAvgTotal>=80){
						echo "A+";
						}else if($aggregateAvgTotal<=79 && $aggregateAvgTotal>=70){
							echo "A";
						}else if($aggregateAvgTotal<=69 && $aggregateAvgTotal>=60){
							echo "A-";
						}
						else if($aggregateAvgTotal<=59 && $aggregateAvgTotal>=50){
						echo "B";
						}
						else if($aggregateAvgTotal<=49 && $aggregateAvgTotal>=40){
						echo "C";	
						}
						else if($aggregateAvgTotal<=39 && $aggregateAvgTotal>=33){
						echo "D";	
						}
						else{
						echo "F";	
