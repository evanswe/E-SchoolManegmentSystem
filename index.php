    ...
    <div id="k-head" class="container"><!-- container + head wrapper -->
        ...
        <?php if(isset($_SESSION['adid'])||
           ...
           echo  "<li>".'<a href="?v=logout"><b style="font-size:15px; color:#F30;" >Logout</b></a>'."</li>";
                ...
                <li><a href="studentlogin" >Student Info</a></li>
               <li><a href="?ad=checkbalancestudent">CheckBalanceStudent</a></li>
    	...
    	<div class="container"><!-- container -->
        	...
        	<div class="row"><!-- row -->
            	...
            	<div class="col-lg-12">
                	...
                	<p class="copy-text text-inverse"><font color="#FF0000">
                    Developed and Desigend  By Farhad Evan(B.Sc In Software Enginnering) & Sohel Rana(B.Sc In CSE) & S.M Muhammad Ali(B.Sc In CSE) 
                    </font></p>
